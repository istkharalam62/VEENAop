...
from VEENAMUSIC.core.userbot import *
...
BOT_LIST = ["VEENA_STRING76_BOT", "SATYAPOSTER2_BOT", "Satya_psmaker_bot", "SATYAHELP09_BOT", "@SATYACONTROLLER09_BOT", "Controllerzip_bot", "Dax_music9_bot"]
