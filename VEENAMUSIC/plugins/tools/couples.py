...
#BOT FILE NAME
from VEENAMUSIC import app as app
from VEENAMUSIC.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="𓊈𒆜彡[𝗜𝗦𝗧𝗞𝗛𝗔𝗥 ]彡𒆜𓊉",
            url=f"https://t.me/VEENA_KI_DUNIYA",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "VEENAMUSIC/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "VEENAMUSIC/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("VEENAMUSIC/assets/cppic.png")
