...
from VEENAMUSIC.misc import SUDOERS
from VEENAMUSIC.utils.database import add_sudo, remove_sudo
from VEENAMUSIC.utils.decorators.language import language
from VEENAMUSIC.utils.extraction import extract_user
from VEENAMUSIC.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    ...
    #await message.reply_photo(photo="https://telegra.ph/file/b55cdd3338f32083bee3b.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
    await message.reply_video(video="https://telegra.ph/file/b55cdd3338f32083bee3b.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
